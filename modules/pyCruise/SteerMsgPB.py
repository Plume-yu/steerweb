...
from OpMsgPB import JobType as JobType_OpMsg
from OpMsgPB import ExecType as ExecType_OpMsg
from OpMsgPB import OpMsg
...
class SteerMsg(OpMsg):
    ...
    def setActor(self, userSN):
        self.session_key = SteerSessionKey.make(userSN, 0, 0, 0)
        return self
